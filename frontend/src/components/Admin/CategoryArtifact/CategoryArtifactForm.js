...
import CategoryArtifactList from "./CategoryArtifactList";
...
function CategoryArtifactForm(props) {
  const {
    values,
    setValues,
    errors,
      ...
      if (values.id == 0) {
        createAPIEndpoint(ENDPIONTS.CategoryArtifact)
          ...
          .then((res) => {
            ...
            setNotify({
              isOpen: true,
              message: "New category artifact is created.",
            });
          })
          .catch((err) => console.log(err));
      } else {
        createAPIEndpoint(ENDPIONTS.CategoryArtifact)
          ...
          .then((res) => {
            ...
            setNotify({
              isOpen: true,
              message: "The category artifact is updated.",
            });
          })
          .catch((err) => console.log(err));
      }
...
export default CategoryArtifactForm;
